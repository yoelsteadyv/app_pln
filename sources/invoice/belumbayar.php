...
<head>
	<title>APP PLN &middot; Invoice - <?php echo $row['NoTagihan']; ?></title>
	<style type="text/css">
		* {
			margin: 0;
		}
...
<body style="font-family: sans-serif;">
	<div style="background-color: #fafafa;padding: 20px;width:80%">
		<table>
			...
			<tr>
				<td colspan="4">
					<h2 style="margin-bottom:30px;">APP PLN</h2>
			<tr>
				<td style="font-weight: bold;font-size:14px;">Alamat</td>
				<td colspan="3">Rumah Dino No.17</td>
				<td></td>
			...
			<tr>
				...
				<td colspan="3">+62 812 9117 7615</td>
				<td></td>
			...
			<tr>
				<td colspan="7" style="padding:20px 0;">
					Silahkan melakukan pembayaran sejumlah <em><?php echo "Rp " . number_format($row['TotalBayar'], 0, '', '.'); ?></em> ke Rekening BRI (24379524), sampai batas akhir tanggal 1 - 10 di awal Bulan.
				</td>
			</tr>
			<tr>
				<td colspan="6"></td>
				<td>
					Rumah Dino, <?php echo date('d-m-Y'); ?>.
					<br>
					<br>
					<br>
					<br>
